...
class ScenicController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('distribution.supplier.scenic.index', compact('lists'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    return redirect('/distribution/supplier/scenic/create/')
                        ->withInput()
...
//                        $picUrl = $disk->imagePreviewUrl($pathName, 'imageView2/0/w/100/h/200');
                ...
                $scenic->save();
                if ($scenic) {
                    return redirect('/distribution/supplier/scenic')->withSuccess('保存成功！');
                }
                return Redirect::back()->withErrors('保存失败！');
            }

            return view('distribution.scenic.create', compact('scenic'));
    ...
    public function edit($id, Request $request)
    {
        try {
            ...
            return view('distribution.supplier.scenic.edit', compact('scenic'));
