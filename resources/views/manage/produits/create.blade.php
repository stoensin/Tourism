                                ...
                                <fieldset>
                                    ...
                                    @if($products )
                                        <div class="form-group{{ $errors->has('productId') ? ' has-error' : '' }}">
                                            <label for="productId" class="col-md-3 control-label">原始产品关联：</label>

                                            <div class="col-md-9">
                                                <select name="productId" class="form-control" style="width: auto;">
                                    ...
                                    <div class="form-group{{ $errors->has('singleNum') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="singleNum" type="text" class="form-control"
                                                   ...
                                                   name="singleNum"
                                                   placeholder="单人限购数量"
                                                   value="{{ old('singleNum') }}" required autofocus>
