        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    <div class="panel-heading">授信管理</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/manage/distribution/credit/create')}}"
                            ...
                            <table class="table table-bordered table-hover  table-condensed">
                                ...
                                @foreach($lists as $item)
                                    <tr title="{{$item->attention}}">
                                        ...
                                        <td>{{$item->distribution? $item->distribution->name:""}}</td>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/manage/distribution/credit/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/manage/distribution/credit/delete/'.$item->id)}}">删除</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-4"><a
                                        href="{{url('/manage/distribution/create/delete')}}"
